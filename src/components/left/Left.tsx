...
const Left = () => {
  return (
    <div className="w-full flex flex-col items-center gap-6 pt-8 pb-12 sticky top-0 bg-white">
      {/* Profile Image */}
     <div className="relative group">
  <div className="w-32 h-32 rounded-full p-1 bg-gradient-to-r from-blue-500 via-purple-500 to-blue-600 shadow-2xl group-hover:shadow-3xl transition-all duration-300 group-hover:scale-[1.02]">
    <Image
      src={award}
      alt="Sumit Sahni"
    ...
    />
      ...
      <div className="text-center px-4">
        <h2 className="text-xl font-semibold text-gray-900 leading-tight hover:underline cursor-pointer">
          Sumit Sahni
        </h2>
        ...
        <a
          ...
          className="inline-flex items-center gap-2 mt-4 px-4 py-2 text-sm font-medium rounded-full 
            ...
            hover:from-[#004182] hover:to-[#0a66c2]
            hover:shadow-lg hover:shadow-blue-500/25
            transform hover:-translate-y-0.5 transition-all duration-200
            border border-blue-500/50"
        >
          <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
            <path fillRule="evenodd" d="M3 5a2 2 0 012-2h10a2 2 0 012 2v10a2 2 0 01-2 2H5a2 2 0 01-2-2V5zm11.293 3.293a1 1 0 011.414 0l2-2a1 1 0 011.414 0v7.586a1 1 0 01-.707.707h-7.586a1 1 0 010-1.414l2-2a1 1 0 011.414 0z" clipRule="evenodd" />
          </svg>
          Download Resume
        </a>
      </div>
        ...
        {[
          {
            ...
            icon: (
              <svg className="w-5 h-5 text-[#0A66C2] hover:text-[#004182]" fill="currentColor" viewBox="0 0 24 24">
          ...
          },
          {
            ...
            icon: (
              <svg className="w-5 h-5 text-[#333] hover:text-black" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="w-full px-4 space-y-2">
        ...
        <div className="space-y-1.5">
          ...
          ].map(({ text, link, badge }, i) => (
            <a
              key={i}
              href={link}
              target="_blank"
              rel="noopener noreferrer"
              className="group flex items-center gap-2 p-3 rounded-xl bg-gradient-to-r from-gray-50 to-white 
                border border-gray-200 hover:border-gray-300 hover:bg-blue-50/50
                hover:shadow-sm transition-all duration-200 text-sm text-gray-900 hover:text-blue-700"
            >
              <span className="text-lg opacity-75 group-hover:opacity-100 transition-opacity">{badge}</span>
              <span className="font-medium group-hover:underline">{text}</span>
              <svg className="w-3.5 h-3.5 ml-auto text-gray-400 group-hover:text-blue-500 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
