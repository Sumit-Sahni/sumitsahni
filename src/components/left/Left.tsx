...
const Left = () => {
  return (
    <div className="w-full flex flex-col items-center justify-between gap-6 pt-8 pb-12 sticky top-0 bg-white shadow-md rounded-3xl border border-gray-200">
      {/* Profile Image */}
        ...
        <div className="space-y-1.5">
          {[
            ...
            >
              ...
              <svg
                className="w-3.5 h-3.5 ml-auto text-gray-400 group-hover:text-blue-500 transition-colors"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
